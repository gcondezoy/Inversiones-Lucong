...
export const obras = [
  ...
  },
  {
    ...
    cliente: 'Municipalidad Provincial de Junín',
    estado: 'Ejecutado',
    descripcion:
      'Remodelación integral de una casona, contemplando trabajos de reforzamiento, renovación de acabados, adecuación de espacios y mejoramiento de la infraestructura, preservando su funcionalidad y valor arquitectónico.',
  ...
  {
    id: 'cementos-inka-lurigancho-chosica',
    categoria: 'Industrial',
    titulo: 'Cementos Inka — Lurigancho-Chosica',
    ubicacion: 'Lurigancho-Chosica, Lima',
    cliente: 'Cementos Inka',
    estado: 'Ejecutado',
    descripcion:
      'Remodelación y ampliación de oficinas administrativas, construcción de pavimento rígido, muros de contención, silos, laboratorio, áreas de molienda y embolsado, subestación eléctrica, veredas y pavimentos adoquinados, como parte de la modernización y ampliación de la planta industrial.',
    img: '/obras/cementos-inka-lurigancho-chosica.png',
    alt: 'Planta cementera Cementos Inka en Lurigancho-Chosica, Lima, ejecutada por Inversiones Lucong',
    destacada: false,
  },
  {
  ...
  },
  {
    ...
    cliente: 'Ministerio de Defensa del Perú',
    estado: 'Ejecutado',
    descripcion:
      'Construcción de un polvorín destinado al almacenamiento seguro de explosivos y municiones, ejecutado bajo estrictos estándares técnicos y de seguridad. El proyecto comprendió la infraestructura principal y obras complementarias para garantizar su correcto funcionamiento.',
